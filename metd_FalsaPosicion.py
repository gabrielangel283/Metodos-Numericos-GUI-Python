...
from clases_Metod_Numericos.Clase_FalsaPosicion import *

class metd_FalsaPosicion():
    def __init__(self, panel):
        self.panel = panel
    
    def mostrarCampos(self):
        # ETIQUETAS
        lblTitulo = Label(self.panel, text="MÉTODO DE FALSA POSICIÓN", fg="red", font=("Arial", 12, "bold italic"))
        ...
        lblResultado.place(x=10, y = 185, width=520, height=245)
